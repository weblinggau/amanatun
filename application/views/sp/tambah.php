                ...
                <div class="card">
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="id_surat_peringatan">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="jenis_sp">
                      <small class="form-text text-danger"><?= form_error('jenis_sp');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Perihal</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="perihal">

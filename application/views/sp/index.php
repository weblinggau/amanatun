    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Surat Peringatan</h1>
          <div class="row mb-3  text-right">
            <div class="col-md-12 mb-2">
              <a href="<?= base_url('admin/tambahsp');?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
...
<section class="cart_area">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $sp->file ;?></td>
      <td>
        <a href="<?= base_url('admin/ubahsp/') ?><?= $sp->id_surat_peringatan;?>" class="badge badge-warning" class="badge badge-success float-right"><i class="fas fa-edit"></i></a>
        <a href="<?= base_url('admin/hapussp/') ?><?= $sp->id_surat_peringatan; ?>" class="badge badge-danger" onclick="javascript: return confirm ('Anda Yakin')"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>

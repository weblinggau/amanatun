        ...
        <div class="container-fluid">
          ...
          <div class="row mb-3  text-right">
            <div class="col-md-12 mb-2">
              <a href="<?= base_url('admin/tambahizin');?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
...
<section class="cart_area">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $izin->nip_pegawai;?></td>
      <td><?= $izin->tgl_izin;?></td>
      <td><?= $izin->jenis;?></td>
      <td><?= $izin->lama;?></td>
      <td><?= $izin->keperluan ;?></td>
      <td><?= $izin->rentang_tanggal ;?></td>
      <td><?= $izin->keterangan ;?></td>
      <td><?= $izin->status ;?></td>
      <td>
        <a href="<?= base_url('admin/ubahizin/') ?><?= $izin->id_izin;?>" class="badge badge-warning" class="badge badge-success float-right"><i class="fas fa-edit"></i></a>
        <a href="<?= base_url('admin/hapusizin/') ?><?= $izin->id_izin; ?>" class="badge badge-danger" onclick="javascript: return confirm ('Anda Yakin')"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>

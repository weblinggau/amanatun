                ...
                <div class="card">
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Id Izin</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="id_izin" value="<?= $izin->id_izin?>" readonly>
                      <small class="form-text text-danger"><?= form_error('id_izin');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Nip Pegawai</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="nip_pegawai" value="<?= $izin->nip_pegawai?>">
                      <small class="form-text text-danger"><?= form_error('nip_pegawai');?></small>
                    </div>
                    <div class="form-group col-4 mr-5" >
                      <label for="exampleFormControlTextarea1">Id Detail Izin</label>
                      <select class="form-control" name="id_detail_izin">
                        <?php foreach ($detail_izin as $detail_izin):?>
                          <?php if ($detail_izin->id_detail_izin == $izin->id_detail_izin) :?>
                        <option value="<?= $detail_izin->id_detail_izin?>" selected="selected"><?= $detail_izin->id_detail_izin?></option>
                        <?php else :?>
                          <option value="<?= $detail_izin->id_detail_izin?>" selected="selected"><?= $detail_izin->id_detail_izin?></option>
                          <?php endif;?>
                        <?php endforeach;?>
                      </select>
                      <small class="form-text text-danger"><?= form_error('id_detail_izin');?></small>
                    </div>

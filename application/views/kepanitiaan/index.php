    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Kepanitiaan</h1>
          <div class="row mb-3  text-right">
            <div class="col-md-12 mb-2">
              <a href="<?= base_url('admin/tambahkepanitiaan');?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
...
<section class="cart_area">
  ...
  <thead>
    <tr>
      <th scope="col">NO</th>
      <th scope="col">Id Kepanitiaan</th>
  ...
  <tbody>
    ...
    <tr>
      <th><?= $i++?></th>
      <th><?= $kepanitiaan->id_kepanitiaan?></th>

      <td><?= $kepanitiaan->nip_pegawai;?></td>
      <td><?= $kepanitiaan->nama;?></td>
      <td><?= $kepanitiaan->tanggal;?></td>
      <td><?= $kepanitiaan->lokasi;?></td>
      <td><?= $kepanitiaan->honor ;?></td>
      <td><?= $kepanitiaan->keterangan ;?></td>
      <td>
        <a href="<?= base_url('admin/ubahkepanitiaan/') ?><?= $kepanitiaan->id_kepanitiaan;?>" class="badge badge-warning" class="badge badge-success float-right"><i class="fas fa-edit"></i></a>
        <a href="<?= base_url('admin/hapuskepanitiaan/') ?><?= $kepanitiaan->id_kepanitiaan; ?>" class="badge badge-danger" onclick="javascript: return confirm ('Anda Yakin')"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>

                ...
                <div class="card">
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Id Absen Pegawai</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="id_absen_pegawai" value="<?= $absen_p->id_absen_pegawai?>">
                      <small class="form-text text-danger"><?= form_error('id_absen_pegawai');?></small>
                    </div>
                    <div class="form-group col-4 mr-5" >
                      <label for="exampleFormControlTextarea1">Id Jenis Surat Peringatan</label>
                      <select class="form-control" name="id_detail_absen_pegawai">
                        <?php foreach ($detail_absen_pegawai as $detail_absen_pegawai):?>
                          <?php if ($detail_absen_pegawai->id_detail_absen_pegawai == $absen_p->id_detail_absen_pegawai) :?>
                        <option value="<?= $detail_absen_pegawai->id_detail_absen_pegawai?>" selected="selected"><?= $detail_absen_pegawai->id_detail_absen_pegawai?></option>
                        <?php else :?>
                          <option value="<?= $detail_absen_pegawai->id_detail_absen_pegawai?>"><?= $detail_absen_pegawai->id_detail_absen_pegawai?></option>
                          <?php endif;?>
                        <?php endforeach;?>
                      </select>
                      <small class="form-text text-danger"><?= form_error('id_detail_absen_pegawai');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Nip Pegawai</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="nip_pegawai" value="<?= $absen_p->nip_pegawai?>">
                      <small class="form-text text-danger"><?= form_error('nip_pegawai');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Tanggal</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="tanggal" value="<?= $absen_p->tanggal?>">
                      <small class="form-text text-danger"><?= form_error('tanggal');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Hari</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="hari" value="<?= $absen_p->hari?>">

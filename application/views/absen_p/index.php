    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Absen Pegawai</h1>
          <div class="row mb-3  text-right">
            <div class="col-md-12 mb-2">
              <a href="<?= base_url('admin/tambahabsen_p');?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
...
<section class="cart_area">
  ...
  <tbody>
    <?php $i=1?>
    <?php foreach($absen_p as $absen_p): ?>
      
    <tr>
      <th><?= $i++?></th>
      <th><?= $absen_p->id_absen_pegawai?></th>
      <td><?= $absen_p->nip_pegawai;?></td>
      <td><?= $absen_p->tanggal;?></td>
      <td><?= $absen_p->hari;?></td>
      <td><?= $absen_p->jam ;?></td>
      <td><?= $absen_p->keterangan ;?></td>
      <td>
        <a href="<?= base_url('admin/ubahabsen_p/') ?><?= $absen_p->id_absen_pegawai;?>" class="badge badge-warning" class="badge badge-success float-right"><i class="fas fa-edit"></i></a>
        <a href="<?= base_url('admin/hapusabsen_p/') ?><?= $absen_p->id_absen_pegawai; ?>" class="badge badge-danger" onclick="javascript: return confirm ('Anda Yakin')"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>

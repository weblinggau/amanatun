                ...
                <div class="card">
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Id Absen Dosen</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="id_absen_dosen" value="<?= $absen_d->id_absen_dosen?>">
                      <small class="form-text text-danger"><?= form_error('id_absen_dosen');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Id Jawal Kuliah</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="id_jadwal_kuliah" value="<?= $absen_d->id_jadwal_kuliah?>">
                      <small class="form-text text-danger"><?= form_error('id_jadwal_kuliah');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Nip Pegawai</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="nip_pegawai" value="<?= $absen_d->nip_pegawai?>">
                      <small class="form-text text-danger"><?= form_error('nip_pegawai');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Tanggal</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="tanggal" value="<?= $absen_d->tanggal?>">
                      <small class="form-text text-danger"><?= form_error('tanggal');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Hari</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="hari" value="<?= $absen_d->hari?>">
                      <small class="form-text text-danger"><?= form_error('hari');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Masuk</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="masuk" value="<?= $absen_d->masuk?>">
                      <small class="form-text text-danger"><?= form_error('masuk');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Keterangan</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="keterangan" value="<?= $absen_d->keterangan?>">

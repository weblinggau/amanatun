    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Absen Dosen</h1>
          <div class="row mb-3  text-right">
            <div class="col-md-12 mb-2">
              <a href="<?= base_url('admin/tambahaabsen_d');?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
...
<section class="cart_area">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Id Jadwal Kuliah</th>
  ...
  <tbody>
    ...
    <?php foreach($absen_d as $absen_d): ?>
      
    <tr>
      <th><?= $i++?></th>
      <th><?= $absen_d->id_absen_dosen?></th>
      <td><?= $absen_d->id_jadwal_kuliah;?></td>
      <td><?= $absen_d->nip_pegawai;?></td>
      <td><?= $absen_d->tanggal;?></td>
      <td><?= $absen_d->hari ;?></td>
      <td><?= $absen_d->masuk ;?></td>
      <td><?= $absen_d->keterangan ;?></td>
      <td>
        <a href="<?= base_url('admin/ubahabsen_d/') ?><?= $absen_d->id_absen_dosen;?>" class="badge badge-warning" class="badge badge-success float-right"><i class="fas fa-edit"></i></a>
        <a href="<?= base_url('admin/hapusabsen_d/') ?><?= $absen_d->id_absen_dosen; ?>" class="badge badge-danger" onclick="javascript: return confirm ('Anda Yakin')"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>

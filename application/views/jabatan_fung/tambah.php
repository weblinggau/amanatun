                ...
                <div class="card">
                  ...
                  <form action="" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="id_jabatan_fungsional">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="nomor_sk">
                      <small class="form-text text-danger"><?= form_error('nomor_sk');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Tanggal Mulai</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="tgl_mulai">
                      <small class="form-text text-danger"><?= form_error('tgl_mulai');?></small>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Tanggal Berakhir</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="tgl_berakhir">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlInput1"  name="nip_dosen">

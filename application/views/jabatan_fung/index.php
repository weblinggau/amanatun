    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Jabatan Fungsional</h1>
          <div class="row mb-3  text-right">
            <div class="col-md-12 mb-2">
              <a href="<?= base_url('admin/tambahajabatan_fung');?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
...
<section class="cart_area">
  ...
  <tbody>
    <?php $i=1?>jabatan_fung
    <?php foreach($jabatan_fung as $jabatan_fung): ?>
      
    <tr>
      <th><?= $i++?></th>
      <th><?= $jabatan_fung->id_jabatan_fungsional?></th>
      <td><?= $jabatan_fung->nip_dosen;?></td>
      <td><?= $jabatan_fung->jabatan;?></td>
      <td><?= $jabatan_fung->nomor_sk;?></td>
      <td><?= $jabatan_fung->tgl_mulai ;?></td>
      <td><?= $jabatan_fung->tgl_berakhir ;?></td>
      <td><?= $jabatan_fung->status ;?></td>
      <td>
        <a href="<?= base_url('admin/ubahjabatan_fung/') ?><?= $jabatan_fung->id_jabatan_fungsional;?>" class="badge badge-warning" class="badge badge-success float-right"><i class="fas fa-edit"></i></a>
        <a href="<?= base_url('admin/hapusjabatan_fung/') ?><?= $jabatan_fung->id_jabatan_fungsional; ?>" class="badge badge-danger" onclick="javascript: return confirm ('Anda Yakin')"><i class="fas fa-trash-alt"></i></a>
      </td>
    </tr>
